...
const CancelOrder = () => {
    ...
    return (
        <>
            <HomeInfo name='Order' secondName="Cancel Order" />
            <div className=" table">
                <div className="row p-3">
                    <div className="d-flex align-items-center border-bottom p-3">
                        <div className="col-md-12"><h5>Cancel Order</h5></div>
                    </div>
                    <table className='mt-3'>
                        ...
                        {compOrd?.map((v, i) => (
                            <tr key={i}>
                                ...
                                <td><div className='fw-bold text-danger' style={{ textTransform: "capitalize" }}>{v?.state}</div></td>
